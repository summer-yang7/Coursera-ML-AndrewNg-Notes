...
# visualize cost data(代价函数可视化)
# ax = sns.tsplot(cost_data, time=np.arange(epoch+1)) #tsplot已经被弃用
...
ax.set_title('learning_rate', fontsize=18)
plt.show()
...
optimizer_dict = {
                ...
                'Adagrad': tf.train.AdamOptimizer,
